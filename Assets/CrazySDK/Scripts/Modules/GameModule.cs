...
namespace CrazyGames
{
    public class GameModule : MonoBehaviour
    {
        ...
        public void HappyTime()
        {
            ...
            _crazySDK.EnsureSDKInitializedAction(HappyTimeSDK, () => { });
        }

        public void GameplayStart()
        {
            _crazySDK.DebugLog("Gameplay start called");
            _crazySDK.EnsureSDKInitializedAction(GameplayStartSDK, () => { });
        }

        public void GameplayStop()
        {
            _crazySDK.DebugLog("Gameplay stop called");
            _crazySDK.EnsureSDKInitializedAction(GameplayStopSDK, () => { });
        }
        ...
        public void HideInviteButton()
        {
            ...
            _crazySDK.EnsureSDKInitializedAction(HideInviteButtonSDK, () => { });
        }

        public void CopyToClipboard(string text)
        {
            _crazySDK.EnsureSDKInitializedAction(() => CopyToClipboardSDK(text),
